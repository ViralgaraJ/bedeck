...
<section class="split">
    ...
    <div class="prose" data-reveal data-reveal-delay="1">
        ...
        <p>We provide engineering products services and comprehensive solutions supported by internationally recognized brands including ISOIL IMPIANTI (Italy) OMC (Italy) Fluidwell (Netherlands) PROTECH (India) Accord Fuel Services (India) UFLOW (India) Hytek GB (UK) Excel Instruments (India), Diesel Quality Technology ( Denmark) and E&H (Sri Lanka).</p>
