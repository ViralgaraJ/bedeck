...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=Inter:wght@400;500;600;700;800&family=Montserrat:wght@700;800;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/css/site.css') }}?v=53">
...
<body @yield('body_attr')>
    ...
    <script src="{{ asset('assets/js/site.js') }}?v=12" defer></script>
    @stack('scripts')
</body>
</html>
